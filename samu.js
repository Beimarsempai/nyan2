...
sendFileFromUrl(logo, image, {quoted: fimg, caption: '*🔥 𝘓𝘰𝘨𝘰𝘴 𝘉𝘺 Vero 🔥*', sendEphemeral: true})
break
...
if (quotedMsg.sender.match('59160703694')) return reply(`🤨`)
