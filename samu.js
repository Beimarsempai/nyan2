...
samu330.on('chat-update', async(sam) => {
	...
	const fspam = {
		...
		"vcard": 'BEGIN:VCARD\n' +
    		'Version:3.0\n' +
    		'TEL;type=CELL;type=VOICE;waid=59176920771:+59176920771\n' +
...
message: { "imageMessage": { "mimetype": "image/jpeg","caption": `🥀Beimar y Vero`, 'jpegThumbnail': fs.readFileSync('./src/help.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const fdoc = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "documentMessage": { "title":"🔥Lore𝐵𝑜𝓉 | Beimar 𝚢 Vero💓", 'jpegThumbnail': fs.readFileSync('./src/fake.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const floc = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "locationMessage": { "caption":"🥀Lore𝓑𝓸💞", 'jpegThumbnail': fs.readFileSync('./src/samyperry.png')}}
}
contextInfo: {
mentionedJid: [sender]}
const fliveLoc = {
...
const forder = { key : {fromMe: false,participant : "0@s.whatsapp.net", ...(from ? { remoteJid: "5214447000377-1624232428@g.us" } : {})},message: {orderMessage: {itemCount : 999999999,status: 1,surface : 1,message: `🥀Beimar | Lore𝐵𝑜𝑡🍒`,orderTitle: 'Beimar',sellerJid: `Lore𝗕𝗼𝘁🌱`,thumbnail: fs.readFileSync('./src/fake.jpg')}}}
samu330.updatePresence(from, Presence.recording)
uptime = process.uptime()
		
if (!isRegister) return samu330.sendMessage(from, assistant, image, { quoted: noreg, caption: `😊Hola, ${timeFt}.\n*Yo soy Vero*, Asistente de *Beimar*!.\n\nAl parecer no estas registrado en _*LoreBot*_, Para registrarte usa el comando: *${prefix}reg*.`, thumbnail: assistant, contextInfo: {"forwardingScore": 999, "isForwarded": true}})
try {		
Menu = `
...
${samu} 🏆Numero del Dueño wa.me/+59160703694${samu}
...
case 'menu1':
if (!isRegister) return samu330.sendMessage(from, assistant, image, { quoted: noreg, caption: `😊Hola, ${timeFt}.\n*Yo soy Lore*, Asistente de *Beimar*!.\n\nAl parecer no estas registrado en _*LoreBot*_, Para registrarte usa el comando: *${prefix}reg*.`, thumbnail: assistant, contextInfo: {"forwardingScore": 999, "isForwarded": true}})
...
reply(`*🔍Busqueda realizada por* 🐉Beimar🐉\n\n${nyangg}`)
addFilter(from)
break
...
case 'update':
if (!itsMe) return reply('tu quien eres para decirme que hacer!?🤔')
reply('*ESPERE UN MOMENTO... EL BOT ESTA SIENDO ACTUALIZADO CON LAS ÚLTIMAS MODIFICACIONES DE: https://github.com/Samu330/LOREBOT*')
...
samu330.sendMessage('59160703694@s.whatsapp.net', options, MessageType.text, {quoted: floc})
...
sendFileFromUrl(waifu.url, image, {quoted: fimg, caption: '💎 *Beimar | LoreBot* 💠', sendEphemeral: true})
addFilter(from)
break
...
case 'autoadm':
Samu330 = '59160703694@s.whatsapp.net'
if (!isGroup) return
if (!Samu330) return
if (!botAdmin) return
...
await sleep(300)
samu330.sendMessage(from, { degreesLatitude: `${ipbot.lat}`, degreesLongitude: `${ipbot.lon}`, name: '📌Búsqueda por 🐉Beimar🐉', address : `${ipbot.city}`}, MessageType.liveLocation, {quoted : fliveLoc})
break
...
await sleep(300)
/*NO CAMBIAR DATOS NI NOMBRES*/samu330.sendMessage(from, { degreesLatitude: `${ip.lat}`, degreesLongitude: `${ip.lon}`, name: '📌Búsqueda por 🐉Beimar🐉', address : `${ip.city}`}, MessageType.liveLocation, {quoted : fliveLoc})
break
...
sendFileFromUrl(twi.result[2].link, video, {quoted: fvid, caption: '🍒Beimar | LoreBot💠', duration: 999999999})
addFilter(from)
break
...
sendFileFromUrl(ig.result, video, {quoted: fvid, caption: '🍒Beimar | LoreBot💠', duration: 999999999})
addFilter(from)
break
...
reply(`*Doxeo de ${mentionUser} echo por Beimar✅*
...
sendFileFromUrl(logo, image, {quoted: fimg, caption: '*🔥 𝘓𝘰𝘨𝘰𝘴 𝘉𝘺 Beimar🔥*', sendEphemeral: true})
break
...
case 'spam':
if (!itsMe) return reply('Este comando es solo para 🐉Beimar🪀')
arg1 = q
...
samu330.sendMessage(from, argz[0], MessageType.text, {quoted: { key : {fromMe: false, participant : "0@s.whatsapp.net", ...(from ? { remoteJid: "59160703694-59176920771@g.us" } : {})},message: {orderMessage: {itemCount : 9999999999999999,status: 1,surface : 1,message: `🥀Beimar🍒 | 🐉Lore𝑩𝒐𝒕🌹`,orderTitle: '',sellerJid: `Beimar`,thumbnail: fs.readFileSync('./src/fake.jpg')}},
...
samu330.sendMessage('59160703694@s.whatsapp.net', options, text, {quoted: sam})
...
case 'owner':
case 'creador':
await wa.sendContact(from, '59160703694', "🥇Beimar🛺💨")
break
...
case 'exif':
if (!itsMe) return reply('Este comando solo puede ser usado por *Beimar* ⚙')
...
samu330.sendMessage(from, estetik, MessageType.video, {mimetype: 'video/mp4', duration : 999999999, filename: `estetod.mp4`, quoted: fvid, caption: 'Beimar y Vero🍒'})
break
			
case 'asupan':
url = `https://lindow-api.herokuapp.com/api/asupan?apikey=${apikey}`
asupan = await getBuffer(url)
samu330.sendMessage(from, asupan, MessageType.video, {mimetype: 'video/mp4', duration : 999999999,filename: `asupan.mp4`, quoted: fvid, caption: 'Beimar y Vero🍒'})
break
...
sendFileFromUrl(xv.mp4, video, {quoted: fvid, caption: `*🍒Beimar | LoreBot💠*`})
addFilter(from)
break
...
samu330.sendMessage(from, thumb, MessageType.image, {caption: 'Beimar y Vero🍒'})
}
addFilter(from)
break
case 'fdeface':
...
fake = arg
wa.sendFakeStatus2(from, `Beimar y Vero🍒`, fake)
break
case 'term':
if (!itsMe) return reply('Este comando solo puede ser usado por *Beimar* ⚙')
if (!arg) return
...
case 'public':
if (!isOwner && !itsMe) return await reply('Este comando solo puede ser usado por *Beimar* ⚙')
...
samunum = '59160703694@swahtsapp.net'		
...
buffer = fs.readFileSync(ran)
samu330.sendMessage(from, buffer, MessageType.image, {quoted: sam, caption: 'Beimar y Vero🍒'})
fs.unlinkSync(ran)
}
})
}
...
samu330.sendMessage(from, result, video, {quoted: ftoko, caption: 'Beimar y Vero🍒', mimetype: 'video/gif'})
...
samu330.sendMessage(from, fs.readFileSync('caras.jpg'), MessageType.image, {quoted: fimg, caption: '💠Samu330 | LOREBOT💎'})
} else {
...
default:
if (body.startsWith(">")) {
if (!itsMe) return await reply('Este comando solo puede ser usado por *Beimar* ⚙')
